...
#                                                                  #
# First I added the relative part for making the JABT instruction  #
# a valid instruction, register use, constant use (valc), source   #
# (rb). Then the part for jumping to adress at rb+c. 		   #
# Then I added the next_pc calculation to the                      # 
# new_pc part to make JTAB work.                                   #
#                                                                  #
####################################################################
