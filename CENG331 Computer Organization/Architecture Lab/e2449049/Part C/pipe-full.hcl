...
#
# First I added the JTAB instruction to the HCL. With JTAB instruction
# I can generate a jump table to speed up the switch8 code. To do that, first
# I added the necessary fields to make JTAB a valid instruction like I did in SEQ.Then
# I faced some data forwarding problems. So I added a similar logic with RET
# to f_pc for JTAB instruction to resolve the issue also I  added a
# bubble to D stage, and stall to F stage since the logic of RET and JTAB are similar.

# I directly added a jump table to my switch8 code making use of jtab command 
# and tested the implemantation with new pipe I got average 26cpe in first try
