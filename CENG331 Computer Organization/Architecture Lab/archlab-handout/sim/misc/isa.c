...
instr_t instruction_set[] = 
{
    ...
    /* another instruction insertion! yay */
    {"mllq",   HPACK(I_ALU, A_MLL), 2, R_ARG, 1, 1, R_ARG, 1, 0 },
    {"modq",   HPACK(I_ALU, A_MOD), 2, R_ARG, 1, 1, R_ARG, 1, 0 },
    {"dvvq",   HPACK(I_ALU, A_DVV), 2, R_ARG, 1, 1, R_ARG, 1, 0 },
    {"jtab", HPACK(I_JTAB, F_NONE), 10, I_ARG, 2, 8, R_ARG, 1, 0 },
...
stat_t step_state(state_ptr s, FILE *error_file)
{
    ...
    (hi0 == I_IRMOVQ || hi0 == I_RMMOVQ || hi0 == I_MRMOVQ ||
     hi0 == I_JMP || hi0 == I_CALL || hi0 == I_JTAB);
