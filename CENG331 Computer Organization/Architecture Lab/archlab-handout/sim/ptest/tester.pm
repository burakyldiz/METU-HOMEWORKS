...
# By default, do not test leaq either!
$testleaq = 0;
...
sub cmdline {
    ...
    getopts('hilcs:Pp:d:Vm:');

    if ($opt_h) {
        print STDERR "Usage $argv[0] [-h] [-i] [-j] [-s <sim>] [-P] [-p <pfile>]\n";
        print STDERR "   -h       print Help message\n";
        print STDERR "   -i       test iaddq instruction\n";
        print STDERR "   -l       test leaq instruction\n";
        print STDERR "   -c       test icmpq instruction\n";
